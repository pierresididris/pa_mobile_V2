...
RequestEntity requestFromJson(String str) =>
    RequestEntity.fromJson(json.decode(str));

String requestToJson(RequestEntity data) => json.encode(data.toJson());
...
class RequestEntity {
  ...
  factory RequestEntity.fromJson(Map<String, dynamic> json) => RequestEntity(
        id: json["id"],
